...
Claude Code に「プロの開発ノウハウ集(スキル17個)」と「開発を自動で進める司令塔(エージェント app-orchestrator)」を追加するキットです。
...
- `skills/` の中の、上の表にある17フォルダ
- `agents/app-orchestrator.md`
- `commands/build-app.md`・`commands/improve-app.md`・`commands/undo-app.md`
...
├── skills/                  ← スキル17個(開発ノウハウ集)
├── agents/                  ← エージェント(app-orchestrator)
└── commands/                ← コマンド(/build-app, /improve-app, /undo-app)
```
