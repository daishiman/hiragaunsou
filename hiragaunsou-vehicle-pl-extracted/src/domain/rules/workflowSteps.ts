...
export const WORKFLOW_STEPS: readonly WorkflowStepDefinition[] = [
  {
    id: 1,
    title: "車両別運行実績表の取り込み",
    summary: "3営業所分のCSVを取り込み、傭車・2重計上・諸口を整理する",
    ...
    notes: [
      ...
      "諸口データは内容を確認したうえで、修正または削除します。判断は画面で1クリック、記録は翌月に引き継がれます。",
    ],
    isJudgementHeavy: true,
  },
  {
    id: 2,
    title: "売上データの取り込みと車番別集計",
    summary: "売上モニタリストを取り込み、車番別に集計。キリンの協力金を配賦する",
