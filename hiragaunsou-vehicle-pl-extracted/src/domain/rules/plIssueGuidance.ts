    ...
    case "anomaly": {
      ...
      return {
        ...
        actions: [
          ...
          "この月は本当にこの数字で合っていれば「このままでOK」にする",
        ],
      };
    }
    ...
    case "overridden":
      return {
        summary:
          ...
          `翌月に同じ直しが必要かどうかを判断できるように、印だけ残しています。`,
        causes: ["請求側の調整があった", "取り込んだ数字が実態と違っていた"],
        actions: [
          "この直しでよければ「このままでOK」にする",
