/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 384d5e86f68cfadea0712a870558d653)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	WORKSPACE_DOMAINS: "senpai-lab.com,tiermind.co.jp";
	BETTER_AUTH_URL: "https://hiragaunsou-vehicle-pl.daishimanju.workers.dev";
	BOOTSTRAP_ADMIN_EMAILS: "manjumoto.daishi@senpai-lab.com";
	BETTER_AUTH_SECRET: string;
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	WORKER_SELF_REFERENCE: Fetcher /* hiragaunsou-vehicle-pl */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKSPACE_DOMAINS" | "BETTER_AUTH_URL" | "BOOTSTRAP_ADMIN_EMAILS" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
