...
export const CHART_CASES: readonly ChartCase[] = [
  ...
  },
  {
    ...
    props: { title: "損益", signed: true, points: pointsOf([120 * 万, 90 * 万, -1_507 * 万]) },
  },
  {
    name: "3ヶ月・最初の月が最大の赤字 (値ラベルが左端に来る)",
    props: { title: "損益", signed: true, points: pointsOf([-1_507 * 万, 90 * 万, 120 * 万]) },
  },
  {
    name: "6ヶ月・赤字混在 + 未取込の月",
    props: {
  ...
  },
  {
    ...
    props: {
      ...
      points: pointsOf(
        [
          520 * 万, 480 * 万, -883 * 万, 310 * 万, 95 * 万, -1_204 * 万, 640 * 万, 720 * 万,
          -55 * 万, 410 * 万, 380 * 万, -960 * 万, 1_150 * 万,
        ],
        {
          references: [
            500 * 万, 460 * 万, 120 * 万, 300 * 万, 100 * 万, -300 * 万, 600 * 万, 700 * 万,
            50 * 万, 400 * 万, 360 * 万, -400 * 万, 1_000 * 万,
          ],
        },
      ),
      referenceLabel: "前年同月",
  ...
  },
  {
    ...
    props: {
      title: "売上",
      points: pointsOf(Array.from({ length: 13 }, (_, i) => (i === 5 ? 12.34 * 億 : 3.2 * 億))),
      referenceLabel: "前年同月",
    },
  },
  {
  ...
  },
  {
    ...
    props: {
      title: "損益",
      signed: true,
      points: pointsOf(Array.from({ length: 13 }, (_, i) => (i % 2 === 0 ? 3_000 : -2_500))),
    },
  },
  {
    ...
    props: {
      title: "売上",
      points: pointsOf(
        Array.from({ length: 13 }, (_, i) => (i === 4 ? 8_450 * 万 : 5_100 * 万)),
        { startMonth: 10 },
      ),
      referenceLabel: "前年同月",
    },
