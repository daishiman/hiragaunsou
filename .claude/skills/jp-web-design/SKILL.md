...
| `references/typography-numerals.md` | 文字・数字を扱う全作業 | メリハリ(主役の作り方・サイズ表)、補足文の規律、Excel基準の数値表記CSS、値/ラベルの描き分け、アフォーダンス、折返し禁則、UXライティング |
| `references/layout-responsive.md` | 画面骨格・レスポンシブ対応 | アプリシェル、余白・角丸、4段ブレークポイント表、モバイル情報削減、コンテナクエリ第一、結果/レポート画面の情報階層 |
